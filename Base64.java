...
public class Base64Test {
    ...
    public static void main(String args[]) throws Exception {
        ...
        //encode("C:\\Users\\ca37440\\Documents\\temp\\temp.zip", "C:\\Users\\ca37440\\Documents\\temp\\projs.txt", IS_CHUNKED);
    	//encode("C:\\temp\\proyectosTemp\\sqlsrcgen.zip", "C:\\temp\\proyectosTemp\\sqlsrcgen.txt", IS_CHUNKED);
    	//encode("C:\\temp\\proyectosTemp\\script.zip", "C:\\temp\\proyectosTemp\\script.txt", IS_CHUNKED);
    	//encode("C:\\temp\\proyectosTemp\\erpsrc.zip", "C:\\temp\\proyectosTemp\\erpsrc.txt", IS_CHUNKED);
    	//encode("C:\\temp\\proyectosTemp\\srcPTC.zip", "C:\\temp\\proyectosTemp\\srcPTC.txt", IS_CHUNKED);
    	//encode("C:\\temp\\proyectosTemp\\sipsaSRC.zip", "C:\\temp\\proyectosTemp\\spsaSRC.txt", IS_CHUNKED);
    	
        /* Decode a file and write the decoded file to file system */
        //decode("C:/temp/projs.txt", "C:/temp/projsDecoded.zip");
    	//decode("C:\\temp\\proyectosTemp\\DMESrc.txt", "C:\\temp\\proyectosTemp\\DMESrc.zip");
    	decode("C:\\temp\\proyectosTemp\\src.txt", "C:\\temp\\proyectosTemp\\src.zip");
    	//decode("C:\\temp\\proyectosTemp\\webspaortodental.txt", "C:\\temp\\proyectosTemp\\webspaortodental.zip");
    	//decode("C:\\temp\\proyectosTemp\\sipsa_spa.txt", "C:\\temp\\proyectosTemp\\sipsa_spa.zip");
    	//decode("C:\\temp\\proyectosTemp\\srcSPA.txt", "C:\\temp\\proyectosTemp\\srcSPA.zip");
